...
/*   Updated: 2023/12/02 12:26:42 by ekhaled          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	init_print_protection_sem(sem_t **print_protection_sem)
{
	*print_protection_sem = sem_open("/print_protection_sem", O_CREAT, 666, 1);
	if (*print_protection_sem == SEM_FAILED)
	{
...
bool	init_data(int argc, char **argv, t_data *data)
{
	...
	if (!init_print_protection_sem(&data->print_protection_sem))
		return (0);
